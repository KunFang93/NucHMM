...
def matrix_visualize(rawhmmfile,histonelistfile,transmat,markstatemat,mark,writematrix,matrixcolor):
    '''Visualize the Transition and Mark-state matrix.'''
    HMM_matrix_visualization(rawhmmfile,histonelistfile,transmat,markstatemat,mark,writematrix,matrixcolor)
